...
with tab1:
    ...
    def acquisition():
            ...
            ut.plot_line_AB(C0, D1, img, draw)
            ut.plot_line_AB(C0, A1, img, draw)
            ut.plot_line_AB(C0, B1, img, draw)
            ut.plot_line_AB(C1, C5, img, draw)
            ut.parallele_AB_C(A1, C2, C5, img, draw)
            ut.parallele_AB_C(E1, C2, C5, img, draw)
    ...
    if len(lp) == 13:
        ...
        if len(lp) == 12:
            ...
            # Calcul
            long_poro, larg_poro = ut.calcul(Diam, Long, A1, E1, C1, C2, C3, C4, C5, A2, E2, A3, E3, B1, D1, img, draw)
        ...
        st.write("Veuillez sélectionner exactement 11 points.")

with tab2:
    st.title("Guide")
    #st.image(Image.open(r"C:\Users\John\Desktop\jupyter_notebooks\Porosimetre\data\result.png"))
    st.image(Image.open(r"data/result_2.png"))
